...
void BSEA(string one,string two,int pengap,int penmismat,int *arr){
    ...
    for (int i=0;i<m;i++){
        ...
        { 
            ...
            { a=array[j+1][1] + penmismat;
                b=array[j+1][0] + pengap;
                    c=array[j][1] + pengap; 
                    if (a <= b && a <= c) 
                    array[j][0]=a; 
                else if (b <= a && b <= c) 
...
void SEA(string one,string two,int pengap,int penmismat,int *arr){
    ...
    for (int i=0;i<m;i++){
        ...
        { 
            ...
            {  a=array[j-1][0] + penmismat;
                b=array[j-1][1] + pengap;
                    c=array[j][0] + pengap; 
                    if (a <= b && a <= c) 
                    array[j][1]=a; 
                else if (b <= a && b <= c) 
...
void DAQ(string one,string two,int pengap,int penmismat,int g,int h){
    ...
    DAQ(one.substr((m/2),m),two.substr(index,n),pengap,penmismat,m/2+g,index+h);
